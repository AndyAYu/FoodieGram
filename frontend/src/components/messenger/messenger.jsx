...
import LiveChatFriendBarContainer from '../livechat_friend/livechat_friend_container';
                        ...
                        return(
                            <div  key={i} className='friend-live-item'>
                                ...
                                <div className="friend-buttons-live">
                                    <button className='friend-page-button' onClick={() => handlePage(i)}>Page</button>
                                    <button className='friend-page-messenger' onClick={() => handleChat(user._id)}>Chat</button>
                                </div>                 
                            </div>
                        )
                    }
